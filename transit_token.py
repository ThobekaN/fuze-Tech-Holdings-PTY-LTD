...
with col_left:
    ...
    if simulate_screenshot_fraud and len(df_transit) > 0:
        new_scan = {"Scan_ID": "WITS-004", "Student_Number / Staff_ID": "2869006", "Transit_Route": "Amic -> WEC -> Wits Junction", "Card_State": "OUTSIDE_SYSTEM", "Token_Age_Sec": 245, "Gate_Action": "CRITICAL ERROR - EXPIRED TOKEN"}
